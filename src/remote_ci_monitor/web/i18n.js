...
(function (root) {
  ...
  var EN = {
    ...
    "host.job_storage": function (a) { return "rcm data " + a.used + (a.limit ? " of " + a.limit : "") + (a.next ? " · next sweep " + a.next : ""); },
  ...
  var KO = {
    ...
    "host.job_storage": function (a) { return "rcm 데이터 " + a.used + (a.limit ? " / " + a.limit : "") + (a.next ? " · 다음 청소 " + a.next : ""); },
