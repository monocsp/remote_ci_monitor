...
(function (root) {
  ...
  function gitFailed(lang, a) {
    ...
    return lang === "ko" ? op + " 실패 — 잡 로그를 보라" : op + " failed, see the job log";
  }
  ...
  var KO = {
    ...
    "host.job_storage_unknown": function () { return "rcm 데이터: 용량을 재지 못했다"; },
